        ...
        <Container style={container}>
          ...
          <Section style={usageDetails(usagePercentage)}>
            ...
            <Text style={detailInfo}>
              <strong>Current Usage:</strong> {quotaUsed} / {quotaLimit}{' '}
              requests
            </Text>
            <Text style={detailInfo}>
          ...
          {isAtLimit ? (
            <>
              <Text style={warningText}>
                ...
                using our service without interruption, please upgrade your plan
                or wait until your quota resets on {resetDate}.
              </Text>
